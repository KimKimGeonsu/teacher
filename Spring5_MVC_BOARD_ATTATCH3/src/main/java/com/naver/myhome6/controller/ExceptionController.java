...
/*
 * 
 * @controllerAdvice 애노테이션을 통해서 이클래스의 객체가 컨트롤러에서 발생하는 인셉션을 처리하는 클래스라는 것을 명시합니다
 * 
 * 만드는 방식은 다음과 같습니다
 * 
 * 1.클래스에 @ControllerAdvicce라는 애노테이션 처리
 * 2.각 메소드에 @ExceptionHandler를 이용해서 적절한 타입의 인셉션을 작성
 * 
 */
